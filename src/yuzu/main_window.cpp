...
void MainWindow::InitializeDebugWidgets() {
    ...
    connect(this, &MainWindow::EmulationStarting, waitTreeWidget,
            &WaitTreeWidget::OnEmulationStarting);
    connect(this, &MainWindow::EmulationStopping, waitTreeWidget,
...
void MainWindow::ConnectMenuEvents() {
    ...
    connect_menu(ui->action_Display_Dock_Widget_Headers, &MainWindow::OnDisplayTitleBars);
...
void MainWindow::OnDisplayTitleBars(bool show) {
